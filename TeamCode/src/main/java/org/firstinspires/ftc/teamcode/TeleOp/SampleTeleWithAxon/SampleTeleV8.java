...
@Disabled
@TeleOp(name = "sampleTeleV8")
public class SampleTeleV8 extends OpMode {
    ...
    public void loop() {
        ...
        if (result != null && result.isValid()) {
            ...
            double yawPos =
                    yawServo.getPosition() + yawVelocity ; //--> added 0.01 bc too much on right
